---
slug: your-first-rails-resource
date: 2020-01-15
title: Ruby on Rails Basics Make Your First Rails Resource 
...
Then run `rails server` in the terminal and in the browser "/user" to view the page you just created.
